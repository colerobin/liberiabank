...
class SuperfishBlock extends SystemMenuBlock {
   ...
   * {@inheritdoc}
   */
  public function setMenuLinkTree(MenuLinkTreeInterface $menuTree) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    $block = parent::create($container, $configuration, $plugin_id, $plugin_definition);
    $block->setMenuLinkTree($container->get('menu.link_tree'));
    $block->setMenuActiveTrail($container->get('menu.active_trail'));
    return $block;
  }
